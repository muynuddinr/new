...
const MovingServices = () => {
  ...
  useEffect(() => {
    ...
    // Particle class representing moving elements
    class Particle {
      x: number;
      y: number;
      size: number;
      ...
      constructor() {
        ...
        const types = ['box', 'truck', 'furniture', 'arrow'];
        this.type = types[Math.floor(Math.random() * types.length)];
        
        switch(this.type) {
          case 'box':
            this.color = `rgba(96, 165, 250, ${Math.random() * 0.6 + 0.2})`;
            break;
          case 'truck':
            this.color = `rgba(34, 197, 94, ${Math.random() * 0.6 + 0.2})`;
            break;
          case 'furniture':
      ...
      draw() {
        ...
        switch(this.type) {
          case 'box':
            ...
            ctx.fillRect(-this.size * 1.5, -this.size * 1.5, this.size * 3, this.size * 0.3);
            ctx.fillRect(-this.size * 1.5, -this.size * 1.5, this.size * 0.3, this.size * 3);
            break;
          case 'truck':
            // Draw truck
            ...
            break;
          case 'furniture':
            // Draw furniture (chair)
            ctx.fillRect(-this.size * 1.5, -this.size, this.size * 3, this.size * 2);
            // Chair back
            ctx.fillRect(-this.size * 1.5, -this.size * 3, this.size * 0.5, this.size * 2);
            // Chair legs
            ctx.fillRect(-this.size * 1.3, this.size, this.size * 0.3, this.size * 1.5);
            ctx.fillRect(this.size * 1, this.size, this.size * 0.3, this.size * 1.5);
            break;
          case 'arrow':
            // Draw arrow
            ctx.beginPath();
  ...
  const features = [
    {
      ...
      description: "End-to-end coordination for seamless residential and commercial relocations"
    },
    {
      icon: "📦",
      title: "Inventory Tracking",
      description: "Real-time tracking of all items being moved with detailed digital records"
    },
    {
      icon: "🚚",
      title: "Equipment & Vehicles",
      description: "Manage your moving trucks and equipment with real-time availability"
    },
    {
      icon: "💬",
      title: "Customer Communications",
      description: "Automated updates and notifications for customers throughout the move"
    },
    {
      icon: "🛡️",
      title: "Insurance Coverage",
      description: "Digital documentation and management of insurance coverage records"
    },
    {
      icon: "🗺️",
      title: "Route Optimization",
      description: "Intelligent routing to minimize fuel costs and maximize efficiency"
    }
  ];

  const benefits = [
    {
      title: "Efficient Moves",
      description: "Streamline operations with optimized scheduling and resource allocation"
    },
    {
      title: "Great Communication",
      description: "Keep customers informed with automated updates and real-time notifications"
    },
    {
      title: "Asset Protection",
      description: "Comprehensive tracking and insurance documentation for maximum protection"
    },
    {
      title: "Operational Excellence",
      description: "Enhance productivity with intelligent workflows and process automation"
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "Fielduo provides move coordination, inventory tracking, equipment and vehicle management, customer communication tools, insurance coverage documentation, and route optimization features specifically designed for moving service providers."
    },
    {
      question: "How can Moving Services businesses improve efficiency with field service management software?",
      answer: "Our software streamlines operations by automating scheduling, tracking inventory in real-time, optimizing routes, managing equipment maintenance, and providing real-time communication between moving crews and customers."
    },
    {
      question: "How does the software help with regulatory compliance for Moving Services?",
      answer: "Fielduo includes built-in compliance checklists, documentation management, audit trails, and reporting tools to ensure your moving operations meet all regulatory requirements and industry standards."
    },
    {
      question: "Does Fielduo offer emergency response or scheduling for Moving Services?",
      answer: "Yes, our platform features emergency scheduling capabilities with priority dispatching, real-time notifications, and rapid mobilization tools to handle urgent moving needs and last-minute changes."
    },
    {
      question: "How does Fielduo support inventory, assets, or equipment tracking for Moving Services?",
      answer: "Our system provides complete inventory management with real-time tracking of items being moved, equipment maintenance schedules, vehicle utilization, and asset allocation for optimal resource management."
    },
    {
      question: "How does the software enhance customer communication for Moving Services?",
      answer: "Fielduo offers automated move updates, inventory notifications, arrival alerts, delivery confirmations, and direct messaging channels to keep customers informed throughout the moving process."
    },
    {
      question: "What benefits do Moving Services clients see after implementing Fielduo?",
      answer: "Clients typically experience 40% reduction in scheduling conflicts, 35% improvement in route efficiency, 30% decrease in inventory loss, and significant improvements in customer satisfaction scores."
    }
  ];
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            ...
            <div className="absolute bottom-64 left-1/2 transform -translate-x-1/2 w-48 h-32 bg-gray-700 rounded-t-lg"></div>
            
            {/* House Windows */}
            <div className="absolute bottom-72 left-1/3 w-8 h-8 bg-gray-900 rounded"></div>
            <div className="absolute bottom-72 right-1/3 w-8 h-8 bg-gray-900 rounded"></div>
            
            {/* Door */}
            <div className="absolute bottom-64 left-1/2 transform -translate-x-1/2 w-12 h-24 bg-gray-800"></div>
            
            {/* Moving Boxes Outside */}
            <div className="absolute bottom-0 left-1/4 w-10 h-10 bg-blue-400/50 rounded"></div>
            <div className="absolute bottom-0 right-1/4 w-12 h-12 bg-blue-400/50 rounded"></div>
            <div className="absolute bottom-12 right-1/3 w-8 h-8 bg-blue-400/50 rounded"></div>
            
            {/* Movers */}
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 -translate-x-24 w-6 h-16 bg-gray-600"></div>
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-x-24 w-6 h-16 bg-gray-600"></div>
          </motion.div>
          
          {/* Moving Dolly with Boxes */}
          <motion.div 
            className="absolute top-1/3 left-1/3 w-48 h-32"
            animate={{ 
              x: [0, 40, 0],
              y: [0, -10, 0]
            }}
          ...
          >
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-32 h-4 bg-gray-600 rounded-full"></div>
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-4 h-16 bg-gray-500"></div>
            
            {/* Boxes on Dolly */}
            <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 -translate-x-12 w-10 h-10 bg-blue-400/50 rounded"></div>
            <div className="absolute bottom-16 left-1/2 transform -translate-x-1/2 translate-x-12 w-10 h-10 bg-blue-400/50 rounded"></div>
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 flex flex-col items-start">
            <motion.h1
              ...
              style={{ textShadow: '0 0 16px #fff, 0 0 32px #3b82f6' }}
            >
              Moving Services
            </motion.h1>
            <motion.p
            ...
            >
              End-to-end moving, packing, and logistics coordination
            </motion.p>
            <motion.div
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Comprehensive tools designed specifically for moving service providers
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 md:px-8 bg-gray-900/30">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Deliver exceptional moving experiences with operational excellence
            </p>
          </motion.div>
              ...
              <div className="md:w-1/2 flex flex-col justify-center">
                ...
                >
                  ...
                  <p className="text-gray-300 mb-6">
                    See how Fielduo can transform your moving services with a personalized demonstration tailored to your specific needs.
                  </p>
                  <motion.button 
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-gray-300">
              Find answers to common questions about our Moving Services solution
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 md:px-8 bg-gradient-to-r from-blue-900/20 to-teal-900/20">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Transform Your Moving Services?</h2>
            <p className="text-lg text-gray-300 mb-10 max-w-2xl mx-auto">
              Join leading moving service providers who trust Fielduo for their field service management
            </p>
